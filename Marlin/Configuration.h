 ...
 *
 *  Last calibration: 12/04/2020
 *  Endstop adjustment:  M666 X0.00 Y-0.73 Z-0.06
 *  Delta settings: L<diagonal_rod> R<radius> H<height> S<segments_per_s> B<calibration radius> XYZ<tower angle corrections>
 *             M665 L267.00         R134.41   H275.93   S80.00            B106.00               X0.09 Y0.31 Z-0.40
 *
 */
...
#define STRING_SPLASH_LINE2 "organom Delta Plus"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Delta Plus"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 267.00 // mm
  ...
  #define DELTA_HEIGHT 275.85 //275.47 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -1.440, -0.348 } // get these from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.154, 0.537, -0.383 } // get these values from auto calibrate
...
#else
  #define Z_PROBE_OFFSET_FROM_EXTRUDER -16.8 // Z offset: -below +above  [the nozzle] -- organom was -16.8
#endif
